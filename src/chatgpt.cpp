...
Recipe *ChatGpt::GetRecipes(std::vector<String> ingredients)
{
  ...
  String text = String("Can you suggest 3 pizza toppings that contains the following ingredients: ") + availableIngredients + String(" and return the response as an array of recipes in json? Split each recipe by title as a string, ingredients as an array and method as an array. Use the metric system.");
