...
lv_obj_t *ui_ToppingHelper;
lv_obj_t *ui_ToppingCnt;
...
lv_obj_t *ui_BtnGetRecipes;
lv_obj_t *ui_PrevLbl4;
...
lv_obj_t *ui_Panel1;
lv_obj_t *ui_Title1;
lv_obj_t *ui_Ingredients1;
lv_obj_t *ui_Panel2;
lv_obj_t *ui_Title2;
lv_obj_t *ui_Ingredients2;
lv_obj_t *ui_Panel3;
lv_obj_t *ui_Title3;
lv_obj_t *ui_Ingredients3;
...
void ui_event_RoundPnl3(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_CLICKED)
    {
        _ui_screen_change(&ui_ToppingHelper, LV_SCR_LOAD_ANIM_FADE_ON, 200, 0, &ui_ToppingHelper_screen_init);
    }
}
void ui_event_HomeBtn(lv_event_t *e)
{
